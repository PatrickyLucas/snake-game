...
backgroun_image = pygame.image.load_extended('grama.jpg')
position_image = (0, 0)
width_size = backgroun_image.get_width()
height_size = backgroun_image.get_height()
...
while True:
    ...
    screen.fill((0,0,0))
    screen.blit(backgroun_image, position_image)
